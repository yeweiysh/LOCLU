function f=localgraphGenerator_varying_cluster_size(n)


clustersize1=ceil((n-20)*rand())+20;
clustersize2=ceil((n-20)*rand())+20;
clustersize3=ceil((n-20)*rand())+20;
clustersize4=ceil((n-20)*rand())+20;
...
filename=['C:\Users\Desktop\local clustering\synthetic graph data\varying cluster size\1\' num2str(n) '\label.mat'];
save(filename,'label');

A=[B11,B12,B13,B14;B12',B22,B23,B24;B13',B23',B33,B34;B14',B24',B34',B44];
filename=['C:\Users\Desktop\local clustering\synthetic graph data\varying cluster size\1\' num2str(n) '\A.mat'];
save(filename,'A');
A=sparse(A);

filename=['C:\Users\Desktop\local clustering\synthetic graph data\varying cluster size\1\' num2str(n) '\network.dat'];

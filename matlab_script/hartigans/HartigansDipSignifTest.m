...
function [dip,xl,xu,p_value,triple,gcm, lcm, mn, mj, ifault] = HartigansDipSignifTest (xpdf, nboot)

% calculate the DIP statistic from the empirical pdf
[dip,xl,xu,triple,gcm, lcm, mn, mj, ifault] = HartigansDipTest(xpdf);
N = length(xpdf);

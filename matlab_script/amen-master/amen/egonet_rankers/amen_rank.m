function [ ranking, scores ] = amen_rank( A, X_Total, weights, varargin )
...
%         [ci, ~, ~] = find(X_Total_Transpose(:,egonet_community));        
        ...
        weights
        [~, weighted_score] = amen_learn_weights( A, X, egonet_community, degrees,  M, p_norm, @amen_objective, X_Total_Transpose, weights );       
